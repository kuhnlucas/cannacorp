  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t('batches.title')}</h1>
        <Button icon={Plus} onClick={() => setShowForm(true)}>
          {t('batches.startNewBatch')}
        </Button>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        >
          ...
          <option value="vegetative">{t('batches.vegetative')}</option>
          <option value="flowering">{t('batches.flowering')}</option>
          <option value="harvested">{t('batches.harvested')}</option>
        </select>
      </div>

      {showForm && (
        <Card title={t('batches.startNewBatch')}>
